...
export function activate(context: ExtensionContext) {
  ...
  context.subscriptions.push(
    ...
    registerCmd(SHOW_REVEALJS_IN_BROWSER, showRevealJSInBrowser(() => main.currentContext?.getExternalUri(), () => main.currentContext?.configuration.browserPath )),
    registerCmd(SHOW_REVEALJS_PRESENTER_VIEW, showRevealJSPresenterView(() => main.currentContext?.getExternalUri(), () => main.currentContext?.configuration.browserPath)),
    ...
    registerCmd(EXPORT_PDF,exportPDF(() => main.currentContext?.getExternalUri(), () => main.currentContext?.configuration.browserPath)),
