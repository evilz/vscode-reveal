...
exports.countLinesToSlide = exports.parseSlides = exports.countLines = void 0;
...
const lineInSeparator = (separator) => (separator.match(/\\n/gm) || []).length + 1;
exports.countLinesToSlide = (slides, horizontalIndex, verticalIndex, slidifyOptions) => {
    ...
    return slides.slice(0, stopSlideIndex).reduce((lines, slide) => {
        const count = lines + exports.countLines(slide.text) + separatorHeight;
...
const addChildrenSlideLines = (slide, horizontalIndex, verticalIndex, verticalSeparatorHeight) => {
    ...
    return slide.verticalChildren
        ? slide.verticalChildren.slice(0, stopVerticalAt).reduce((innerLines, innerSlide) => {
            return innerLines + exports.countLines(innerSlide.text) + verticalSeparatorHeight;
        }, 0)
        : 0;
};
const parseSlide = (slideContent, index, documentOption) => {
...
const getVerticalSlides = (slideContent, documentOption) => {
...
const findSlideAttributes = (text) => {
